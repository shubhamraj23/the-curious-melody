    ...
    <div>
      <div className="bg-shade-2">
        <div className="flex flex-col items-center justify-center" style={{height: `${divHeight}px`}}>
          ...
          <p className="text-black dancing-script tagline-font">There is always something bigger hidden</p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 my-16">
            ...
            <div className="md:col-span-2 h-full">
              <div style={{marginTop: `${marginTop}px`}}>
                <p className="text-left patrick-hand text-lg md:text-2xl text-black mx-4 md:mx-8" id="profile-description">
